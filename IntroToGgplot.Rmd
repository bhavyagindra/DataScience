...
Here are twocomplicated bar graphs for us to break down. 
```{r}
...
4) Make a bar chart of drinks
```{r}

```

4) Make a bar chart of drinks and color the bars by sex. Do not worry if the guide/legend does not quite work
```{r}

```

5) Make a histogram of income. Color the bars some color other than black
```{r}

```

6) Make a boxplot of income by sex.
```{r}
